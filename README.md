...
- 7科目・135論点のABC重要論点マップ（A 68 / B 43 / C 24）
- 4択、一問一答、計算、比較問題
- 正解／ほぼ正解／不正解の自己採点と解説
...
`src/data/abcTopicMap.json`に、2026-06-18版の一次試験7科目・135論点を収録しています。Practice画面では科目とA/B/C重要度で論点を確認でき、問題化済みの論点はその場から演習できます。

- A論点：過去問で高頻度・安定出題。最優先で演習
- B論点：A論点の周辺と上積み領域
- C論点：低頻度・細部・時事性の強い領域

初期状態ではA 85% / B 15%を目安に出題し、A論点の50%以上へ着手かつ正答率75%以上になるとA 70% / B 25% / C 5%へ広げます。復習・Weakは重要度にかかわらず優先されます。既存の問題IDと学習履歴は維持されます。
...
src/data/abcTopicMap.json 一次試験7科目のABC重要論点マップ
